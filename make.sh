...
LDFILES="$BIN/entry.o $BIN/kernel.o $BIN/graphics.o $BIN/text.o $BIN/mem.o $BIN/idt.o"
...
i386-elf-gcc $CCFLAGS -c Interrupts/idt.cpp    -o $BIN/idt.o
i386-elf-gcc $CCFLAGS -c Memory/mem.cpp        -o $BIN/mem.o
i386-elf-gcc $CCFLAGS -c Font/text.cpp        -o $BIN/text.o
